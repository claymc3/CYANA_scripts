...
files = [
['rota8000-arg.data', gcmap, [0, 0.02, 0.2, 1], 'Arginie (ARG,R)'],
['rota8000-asn.data', gcmap, [0, 0.02, 0.2, 1], 'Asparagine (ASN,N)'],
['rota8000-gln.data', gcmap, [0, 0.02, 0.2, 1], 'Glutamine (GLN,Q)'],
['rota8000-glu.data', ycmap, [0, 0.02, 0.2, 1], 'Glutamic Acid (GLU,E)'],
['rota8000-his.data', pcmap, [0, 0.02, 0.2, 1], 'Histadine (HIS,H)'],
['rota8000-ile.data', bcmap, [0, 0.02, 0.2, 1], 'Isoleucine (ILE,I)'],
['rota8000-leu.data', bcmap, [0, 0.02, 0.2, 1], 'Leucine (LEU,L)'],
['rota8000-lys.data', gcmap, [0, 0.02, 0.2, 1], 'Lysince (LYS,K)'],
['rota8000-met.data', bcmap, [0, 0.04, 0.2, 1], 'Methionine (MET, M)'],
['rota8000-trp.data', pcmap, [0, 0.02, 0.2, 1], 'Tryptophan (TRP,W)']]
...
files = [
['rota8000-asp.data', ycmap, [0, 0.02, 0.2, 1],'Aspartic Acid (ASP,D) '],
['rota8000-phetyr.data', pcmap, [0, 0.02, 0.2, 1], 'Phenylalanine/Tyrosine (PHE,F/TRY,Y)']]
for file,cmap, bounds, label in files:
	data = np.full((360, 360), 0, dtype=np.float64)
	linedict = {}
	with open(file) as fn:
